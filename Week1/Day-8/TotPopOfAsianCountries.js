...
inp.on("close", () => {
//start-here
// For simplification purpose number of countries has been reduced as it was taking long to process
var restcountries = [
{
"name": "Afghanistan",
"topLevelDomain": [
...
let AsianCountry = restcountries.filter((acountry) => acountry.region = "Asia")
let totalPop = AsianCountry.reduce((totalpopln,country) => {
 	return country.population+totalpopln    
},0)
